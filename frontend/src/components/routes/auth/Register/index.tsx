  ...
  return (
    <>
      <header className={classes.header}>
        <h2>{t`Welcome to ${getConfig("VITE_APP_NAME", "GX.Events")} 👋`}</h2>
        <p>
          <Trans>
            Create an account or{" "}
            <NavLink to={"/auth/login"}>{t`Log in`}</NavLink> to get started
          </Trans>
        </p>
      </header>
      ...
      <div className={classes.registerCard}>
        <form
          onSubmit={form.onSubmit((values) =>
            registerUser(values as RegisterAccountRequest)
          )}
        >
          ...
          <Trans>
            ...
            <NavLink
              ...
              to={
                getConfig(
                  "VITE_TOS_URL",
                  "https://www.g-techthailand.com/gxevents/privacy/terms.html"
                ) as string
              }
            >
              Terms of Service
