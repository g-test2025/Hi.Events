...
export const PoweredByFooter = (
  ...
  const footerContent = isHiEvents() ? (
    <>
      {t`Planning an event?`}{" "}
      <a
        href="https://www.g-techthailand.com"
        target="_blank"
        className={classes.ctaLink}
        title={
          "Effortlessly manage events and sell tickets online with GX Events"
        }
      >
  ...
  return (
    <div {...props} className={classNames(classes.poweredBy, props.className)}>
      <div className={classes.poweredByText}>{footerContent}</div>
    </div>
  );
};
